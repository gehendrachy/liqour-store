...
<head>
    ...
    <link rel="icon" href="{{ asset('storage/setting/favicon/thumb_') }}" type="image/png"/>
...
<form method="POST" action="{{ route('login') }}">
    ...
    <div class="inputGroup inputGroup1">
        ...
        <input type="text" name="login" value="{{ old('username') ?: old('email') }}" required autofocus id="loginEmail" maxlength="254" @if ($errors->has('username') || $errors->has('email')) is-invalid @endif form-control {{ $errors->has('username') || $errors->has('email') ? ' is-invalid' : '' }}"/>
...
<div class="image-container">
    ...
    <div class="img-cty">
        <img src="{{ asset('storage/setting/logo/'.$setting->logo) }}" alt="Liquor Store logo">
    </div>
</div>
