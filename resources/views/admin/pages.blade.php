    ...
    <script>
        $(document).ready(function () {
            var updateOutput = function (e) {
                ...
                $.ajax({
                    method: "POST",
                    url: "{{ URL::route('admin.pages.order_pages')}}",
                    data: {
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.pages.list') }}">Pages</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Pages List</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-md-6 col-sm-12 text-right hidden-xs">
                    <a href="{{ $id != 0 ? route('admin.pages.list') : route('admin.dashboard') }}" class="btn btn-sm btn-outline-primary" title="Go Back">
