...
class VariationController extends Controller
{
    ...
    {
        $variations = Variation::with('sub_variation')->orderBy('order_item')->get();
        // dd($variations);
        return view('admin.variations', array('variations' => $variations, 'id' => '0'));
    }
    ...
    public function create(Request $request)
    {
        ...
        $variation->display = $request->input('display');
        ...
        if ($variation->save()) {
			...
			return redirect()->to('/admin/variations')->with('status', 'Variation Added Successfully!');	        	
        }else{
